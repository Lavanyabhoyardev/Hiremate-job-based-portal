    ...
    <header className="fixed top-0 left-0 right-0 z-30 pointer-events-none">
      ...
      <div className="flex items-center justify-between px-3 sm:px-6 py-2 sm:py-4 gap-2">
          ...
          <div className="flex items-center gap-2 sm:gap-3 bg-[#12121A]/80 backdrop-blur-xl border border-[#1E1E2E] rounded-2xl px-3 sm:px-5 py-2 sm:py-3">
            ...
            <div>
              ...
              <p className="text-[#8888A0] text-[8px] sm:text-[10px] tracking-wider uppercase hidden sm:block">
                ...
                <a
                  href="https://www.linkedin.com/in/lavanyabhoyar/"
                  target="_blank"
        ...
        <div className="pointer-events-auto flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
          ...
          {/* Clerk Auth Buttons */}
          <div className="bg-[#12121A]/80 backdrop-blur-xl border border-[#1E1E2E] rounded-2xl px-2.5 sm:px-4 py-1.5 sm:py-2 transition-all flex items-center justify-center min-w-[70px]">
            <Show when="signed-out">
              <SignInButton mode="modal">
                <button className="text-xs font-medium text-[#00E5A0] hover:text-[#00CC8E] transition-colors py-1">
                  Log in
                </button>
              </SignInButton>
            </Show>
            <Show when="signed-in">
              <UserButton 
                appearance={{
                  elements: {
                    userButtonAvatarBox: "w-6 h-6 sm:w-7 sm:h-7 rounded-full border border-[#1E1E2E]"
                  }
                }}
              />
            </Show>
